...
usage () {
    ...
    printf "OPTIONS\n"
    printf "\t[-n DOMAIN]\n\n"
    printf "\tDomain name resolved to the shadowsocks-manager web application.\n\n"
    printf "\t[-u USERNAME]\n\n"
    ...
    printf "\t[-e EMAIL]\n\n"
    printf "\tEmail for the shadowsocks-manager administrator.\n"
    printf "\tAlso, be used as the sender of the account notification Email.\n\n"
    printf "\t[-t TIMEZONE]\n\n"
    printf "\tSet Django's timezone, default is 'UTC'.\n"
    printf "\tStatistics period also senses this setting. Note that AWS billing is based on UTC.\n\n"
    printf "\t[-r PORT_BEGIN]\n\n"
